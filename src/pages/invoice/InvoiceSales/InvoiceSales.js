...
const InvoiceSales = () => {
  ...
  const tabs = [
    ...
    { icon: "fas fa-user", label: "Müşteri" },
  ...
  const handleRemoveRow = (rowIndex) => {
    setItems((prev) => {
      if (prev.length <= 1) return prev; // min satır 1
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Fatura verileri:", items);
            ...
            <Tab tabs={tabs}>
              ...
              <div>
                <div className="relative mb-6">
                  ...
                  <button
                    type="button"
                    className="absolute right-0 top-7 px-4 py-3.5 bg-amber-500 text-white rounded-r-lg hover:bg-amber-600 transition-colors"
                  >
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <Input
                    ...
                    icon="fas fa-user"
                    readOnly
                    placeholder="Seçilen müşteri"
                  />
                  <Input label="Müşteri Kodu" icon="fas fa-id-card" readOnly />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <Input label="Vergi No" icon="fas fa-building" readOnly />
                  <Input
                    label="Vergi Dairesi"
        ...
        <div className="w-80 space-y-6">
          ...
          <InfoCard title="Bilgilendirme" icon="fas fa-lightbulb">
            <div className="space-y-2 text-sm leading-relaxed">
              ...
              <p>
                <strong>• Müşteri:</strong> Mutlaka seçilmelidir.
              </p>
              <p>
              ...
              <p>
                <strong>• Vade:</strong> Ödeme vadesi belirlenmelidir.
              </p>
            </div>
          </InfoCard>
        </div>
